...
---
<details>
<summary> Описание требований проекта и начальной структуры кода</summary>
...
(в моём случае поддержки БД нет, данные о всех квизах хранятся в памяти)
